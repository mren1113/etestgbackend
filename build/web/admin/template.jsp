                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-puzzle-piece"></i><a href="#">xxxxxxxxxx</a></li>
                            <li><i class="fa fa-id-badge"></i></i><a href="#">xxxxxxxxxx</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i>xx</li>
                            <li><i class="menu-icon ti-themify-logo"></i>xxx</li>
                        </ul>
                    </li> 
