                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="container-fluid" style="padding: 10px 60px;">
                                <div class="col-12">
                                    <!--FORM เพิ่มข้อมูล-->
                                    <form action="SeatManagementInsert" method="POST">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="number" class="form-control" name="seat_exam" placeholder="กรอก จำนวนที่นั่งสอบ ต่อแถว" onKeyPress="if (this.value.length == 3)
